...
function cargarDatose() {
    ...
    if ($.fn.DataTable.isDataTable('#tbProducto1')) {
        $('#tbProducto1').DataTable().destroy();
    }

    $('#tbProducto1 tbody').html('');
        ...
        function (response) {
            ...
            if (response.estado) {
                ...
                $.each(response.objeto, function (i, row) {
                    ...
                    ).appendTo("#tbProducto1 tbody");

                })
            }

            table = $('#tbProducto1').DataTable({
                responsive: true
            });
        },
        function () {
...
$('#tbProducto1 tbody').on('click', 'button[class="btn btn-sm btn-primary mr-1"]', function () {
...
$('#tbProducto1 tbody').on('click', 'button[class="btn btn-sm btn-danger"]', function () {
